      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <button
            ...
            className="group bg-indigo-600 px-8 py-4 rounded-lg text-white font-semibold text-lg hover:shadow-xl hover:shadow-indigo-500/30 transition-all duration-300 flex items-center space-x-2"
          >
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <div className="flex items-center space-x-2 border border-indigo-500/20 rounded-full px-4 py-2 shadow-sm bg-gradient-to-r via-blue-200 to-purple-300">
            ...
            <span className="text-sm font-medium ">AI-Driven Practice</span>
          </div>
