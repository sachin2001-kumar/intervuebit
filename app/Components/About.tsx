...
export const About = () => {
  ...
  return (
    <section
      ref={ref}
      id="About"
      className="max-w-6xl m-16 mx-auto px-6 flex flex-col shadow-lg hover:shadow-2xl transition-all justify-center p-10 border-2 border-gray-700 rounded-2xl scroll-mt-24 bg-gradient-to-r from-[#746e63db] via-[#746e63db] to-[#746e63db] hover:shadow-[#a78d60]"
    >
      {/* Heading */}
      <motion.h2
